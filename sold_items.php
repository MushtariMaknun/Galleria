...
<head>
    ...
    <title>Galleria || Sold Items</title>
                                    ...
                                    <div class="wishlist-content">
                                            ...
                                            <div class="table-content table-responsive mb-50">
                                                ...
                                                <?php
                                                            ...
                                                            $get_sold = "select * from order_details where ARTIST_ID='$id'";
                                                            $result = $conn->query($get_sold);
                                                            if($result)
                                                            {
                                                                while($row = $result->fetch_assoc())
                                                                {
                                                                    ...
                                                                    $sold_art="select * from artwork where ARTWORK_ID='$art_id'";
                                                                    $run = $conn->query($sold_art);
                                                                    while($a_row = $run->fetch_assoc())
                                                                    {
                                                                        $title=$a_row['TITLE'];
                                                                        $image=$a_row['IMAGE'];
                                                                    }
