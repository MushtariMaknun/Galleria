                    ...
                    <div class="row" style="margin-left: -5px;margin-right: -30px;">
                        ...
                        <div class="col-md-12">
                            <?php
                             ...
                             echo "<div class='dropdown f-left' style='margin: 3px 20px -5px 15px;'>
...
<script>
 ...
 $(document).ready(function(){ 
    ...
    function load_unseen_notification(view = '',id)
     {
