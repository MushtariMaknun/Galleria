                                ...
                                <div class='row' style='margin-left: -5px;'>
                                                ...
                                                <div class='col-md-6'>
                                                    <div class='payment-details box-shadow p-30 mb-50'>
                                                        <h6 class='widget-title border-left mb-20'>Profit</h6>
                                                        <table>
                                                            <tr>
                                                                <hr>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class='order-total'>Account Balance</td>
                                                                <td class='order-total-price'>TK. $earn</td>
                                                            </tr>
