...
<body>
    ...
    <div class="wrapper">
                ...
                <div class="slider-content" >
                    <div class="row" >
                        <div class="active-slider-1 slick-arrow-1 slick-dots-1">
                            ...
                            <div class="col-md-12">
                                <div class="layer-1">
                                    <img style='height: 100%; width: 100%; object-fit: contain' src="img/slider/slider-1/white_dots.jpg" alt="">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="layer-1">
                                    <img style='height: 100%; width: 100%; object-fit: contain' src="img/slider/slider-1/wizka1.jpg" alt="">
        ...
        <section id="page-content" class="page-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="by-brand-product">
                        <div class="row active-by-brand slick-arrow-2">
                            ...
                            <?php
                                $get_products = "select * from artwork where category='animal' order by rand() LIMIT 0,5";
            ...
            <!-- MUltiframes PRODUCT SECTION START -->
                ...
                <div class="container">
                    ...
                    <div class="featured-product">
                        <div class="row active-featured-product slick-arrow-2">
                            <!-- product-item start -->
                            <?php
                                $get_products = "select * from artwork where category='multiframe' order by rand() LIMIT 0,5";
                                $result = $conn->query($get_products);
                                while($row = $result->fetch_assoc())
                                {
                                    $art_id=$row['ARTWORK_ID'];
                ...
                <div class="container">
                    ...
                    <div class="by-brand-product">
                        <div class="row active-by-brand slick-arrow-2">
                           ...
                           <?php
                                $get_products = "select * from artwork where category='cosmos' order by rand() LIMIT 0,5";
                                $result = $conn->query($get_products);
                                while($row = $result->fetch_assoc())
                                {
                                    $art_id=$row['ARTWORK_ID'];
                ...
                <div class="container">
                    ...
                    <div class="by-brand-product">
                        <div class="row active-by-brand slick-arrow-2">
                            <!-- single-brand-product start -->
                           <?php
                                $get_products = "select * from artwork where category='city' order by rand() LIMIT 0,5";
                                $result = $conn->query($get_products);
                                while($row = $result->fetch_assoc())
                                {
                                    $art_id=$row['ARTWORK_ID'];
