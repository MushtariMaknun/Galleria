...
<head>
    ...
    <title>Galleria || Signup Customer</title>
    ...
    <div class="wrapper">
        ...
        <!-- END HEADER AREA -->
         ...
         <!-- BREADCRUMBS SETCTION START -->
                                    ...
                                    <a href="#" style="font-weight: bold" ><div class='circle-link blue-circle-user'><img src="../../img/login/register_user.png" alt=""></div >Customer</a>
                
                
                
                                    <a href="signup_artist.php" style="font-weight: bold" ><div class='circle-link blue-circle-user'><img src="../../img/login/register_artist.png" alt=""></div >Artist</a>
                    ...
                    <div class="row">
                        ...
                        <div class= "col-md-8 col-md-offset-2">
                            <div class="new-customers" style="margin-left: 80px;margin-right:80px">
                                <form action="checksignc.php" method="post">
                                    ...
                                    <div class="login-account p-30 box-shadow" >
                                        ...
                                        <input type="text"  class="cname" name="cf_name" placeholder="First Name" required>
                                        <input type="text" class="cname" name="cl_name"  placeholder="last Name" required>
                                        <input type="text" class="cphone" name="cphone" placeholder="Phone No." required>
                                        <input type="text" class="cemail" name="cemail" placeholder="Email" required>
                                        <input type="password" class="cpass" name="cpass" placeholder="Password" required>
