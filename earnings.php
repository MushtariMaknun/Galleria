            ...
            <div class="login-section mb-80">
                <div class="container">
                    ...
                    <?php
                        ...
                        $get_earnings = "select * from artist where artist_id='$id'";
                        $result = $conn->query($get_earnings);
                        if($result)
                        {
                            while($row = $result->fetch_assoc())
                            {
                                ...
                                <div class='row' style='margin-left: -5px;'>
                                                ...
                                                <div class='col-md-6'>
                                                    <div class='payment-details box-shadow p-30 mb-50'>
                                                        <h6 class='widget-title border-left mb-20'>my earnings</h6>
                                                        <table>
                                                            <tr>
                                                                <hr>
                                                            </tr>
