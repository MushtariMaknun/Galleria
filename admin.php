    ...
    <div class="wrapper">
        ...
        <div class="breadcrumbs-section plr-200 mb-80">
            <?php
                ...
                $id=$_SESSION["id"];
                $get_admin = "select * from admin where admin_id='$id'";
                         ...
                         while($row = $result->fetch_assoc())
                         {
                            ...
                            echo"
                                    ...
                                    <a href='#' style='font-weight: bold' ><div class='circle-link blue-circle-user'><img src='../../img/login/register_user.png'></div ></a>
                                          ...
                                          <h2 style='margin-left:460px;'>$first_name $last_name</h2>
                        ...
                        <div class="col-md-12">
                            <div class="blog-option box-shadow mb-30 clearfix" style="padding-left: 15px;">
                                ...
                                <div class='dropdown f-left ' style='margin: 5px 20px -5px 15px;'>
                                 ...
                                 <a href='admin.php'>
                                       <h6 class='widget-title border-left mb-10'>Artists</h6>
                                ...
                                <div class="dropdown f-left" style="margin: 5px 20px -5px 15px;">
                                   <a href="profit.php">
                                       <h6 class="widget-title border-left mb-10 ">profit</h6>
                                    ...
                                    <div class="shopping-cart-content">
                                            ...
                                            <div class="table-content table-responsive mb-50">
                                                <table class="text-center">
                                                    <thead>
                                                        <tr>
                                                            <th class="product-thumbnail">artists</th>
                                                            <th class="product-remove">block</th>
                                                            <th class="product-remove">unblock</th>
                                                        ...
                                                        <tr>
                                                            <td class='product-thumbnail'>
                                                                ...
                                                                <div class='pro-thumbnail-info text-left'>
                                                                    <h6 class='product-title-2' style='margin-top: 48px;'>
                                                                        <a href='profile.php?profile_id=$artist_id'>$f_name $l_name</a>
                                                                    </h6>
                                                                    
                                                                </div>
                                                            </td>
                                                            
                                                    <form action='check_block.php?artist_id=$artist_id' method='post'>";
                                                        if($is_blocked==0)
                                                        {
                                                           echo "<div class='radio' style='align-content: center'>
                                                                
                                                               <td class='product-price' >
                                                                <input type='radio' name='status' id='optionsRadios1' value='block'>  Block
                                                                </td>
                                                                
                                                               <td class='product-price'>
                                                                <input type='radio' name='status' id='optionsRadios2' value='unblock' checked>  Unblock
                                                                </td>
                                                        ...
                                                        else
                                                        {
                                                            echo "<div class='radio' style='align-content: center'>
                                                               ...
                                                               <td class='product-price' >
                                                                <input type='radio' name='status' id='optionsRadios1' value='block' checked>  Block
                                                                </td>
                                                                
                                                               <td class='product-price'>
                                                                <input type='radio' name='status' id='optionsRadios2' value='unblock' >  Unblock
                                                                </td>
                                               ...
                                               echo"  
                                                <td class='product-price' >
                                                    <div>
                                                    <button class='submit-btn-1 btn-hover-1' name='apply' type='submit' >apply</button>
