...
<head>
    ...
    <title>Galleria || Shop By Category </title>
                        ...
                        <div class="col-md-3 col-md-pull-9 col-sm-12">
                            ...
                            <!-- shop-filter -->
                             <form action="shop.php" method="POST" >
                                ...
                                <aside class="widget widget-categories box-shadow mb-50">
                                    <h6 class="widget-title border-left mb-20">Categories</h6>
                                    <div id="cat-treeview">
                                    
                                        
                                        <select  name="cat_side" style="width: 200px;">
                            ...
                            <aside class="widget operating-system box-shadow mb-30">
                                <h6 class="widget-title border-left mb-20">TYPE</h6>
                                 <div class="radio">
                                     
                                
                                    <label><input type="radio" name="optionType" id="optionType1" value="illustration" >Illustration</label><br>
                                    
                                    <label><input type="radio" name="optionType" id="optionType2" value="photography">Photography</label><br>
                                    
                                    <label><input type="radio" name="optionType" id="optionType3" value="painting">Painting</label><br>
                            ...
                            <!-- orientation -->
                            <aside class="widget operating-system box-shadow mb-30">
                                <h6 class="widget-title border-left mb-20">Orientation</h6>
                                <div class="radio">
                                    
                                
                                    <label><input type="radio" name="optionOrientation" value="vertical">Vertical</label><br>
                                    
                                    <label><input type="radio" name="optionOrientation" value="horizontal">Horizontal</label><br>
                                 ...
                                 <button class="submit-btn-1 btn-hover-1" type="submit" style="margin-top: 20px">Filter</button>
                            </form>     
