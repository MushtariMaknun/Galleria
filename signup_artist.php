...
<head>
    ...
    <title>Galleria || Signup Artist</title>
    ...
    <div class="wrapper">
        ...
        <!-- END HEADER AREA -->
         ...
         <!-- BREADCRUMBS SETCTION START -->
                                    ...
                                    <a href="signup_cust.php" style="font-weight: bold" ><div class='circle-link blue-circle-user'><img src="../../img/login/register_user.png" alt=""></div >Customer</a>
                
                
                
                                    <a href="#" style="font-weight: bold" ><div class='circle-link blue-circle-user'><img src="../../img/login/register_artist.png" alt=""></div >Artist</a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class= "col-md-8 col-md-offset-2">
                            <div class="new-customers" style="margin-left: 80px;margin-right:80px">
                                <form action="checksigna.php" method="post">
                                    <h6 class="widget-title border-left mb-50">Create an account</h6>
                                    
                                    
                                    
                                    <div class="login-account p-30 box-shadow" >
                                        
                                       <input type="text"  class="aname" name="af_name" placeholder="First Name" required>
                                        <input type="text" class="aname" name="al_name"  placeholder="last Name" required>
                                        <input type="text" class="aphone" name="aphone" placeholder="Phone No." required>
                                        <input type="text" class="aemail" name="aemail" placeholder="Email" required>
                                        
                                        
                                        <div class="row">
                                                        <div class="col-sm-6">
                                                            <h6>Galleria link : www.galleria.com/</h6>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <input type="text" class="alink" name="alink" placeholder="link" required>
                                                        </div>
                                        </div>
                                        
                                        
                                       
                                        <input type="password" class="apass" name="apass" placeholder="Password" required>
                                        
                                        <div class="checkbox">
                                            <label class="mr-10"> 
                                                <small>
                                                    <input type="checkbox" class="accept" name="accept" required>I accept the <a href="#" style="font-weight: bold">Terms of Use</a> and <a href="#" style="font-weight: bold">Privacy Policy</a>
                                                </small>
                                            </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <button class="submit-btn-1 mt-20 btn-hover-1" type="submit" value="register"> Create an Account</button>
                                            </div>
                                            <div class="col-md-6">
